...
class Action:
    ...
    @classmethod
    def create_post(cls, platform: str, content: str, images: Optional[List[str]] = None,
                    source_alpha_id: str = "") -> "Action":
        """快捷创建发布行动"""
        return cls(
    ...
    @classmethod
    def create_message(cls, platform: str, recipient: str, content: str,
                       source_alpha_id: str = "") -> "Action":
        """快捷创建发送消息行动"""
        return cls(
